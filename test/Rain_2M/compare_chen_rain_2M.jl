...
q_rai_plt_chen = CSV.read("test/Rain_2M/q_rai_plt_chen.csv", DataFrame, header= false)
q_rai_end_chen = CSV.read("test/Rain_2M/q_rai_end_chen.csv", DataFrame,header= false)
q_rai_middle_chen = CSV.read("test/Rain_2M/q_rai_middle_chen.csv", DataFrame, header=false)
t_plt_chen = CSV.read("test/Rain_2M/t_plt_chen.csv", DataFrame,header=false)
z_plt_chen = CSV.read("test/Rain_2M/z_plt_chen.csv", DataFrame,header=false)
z_centers_end_chen = CSV.read("test/Rain_2M/z_centers_end_chen.csv", DataFrame,header=false)
z_centers_middle_chen = CSV.read("test/Rain_2M/z_centers_middle_chen.csv", DataFrame,header=false)

q_rai_plt_original = CSV.read("test/Rain_2M/q_rai_plt_original.csv", DataFrame,header= false)
q_rai_end_original = CSV.read("test/Rain_2M/q_rai_end_original.csv", DataFrame,header= false)
q_rai_middle_original = CSV.read("test/Rain_2M/q_rai_middle_original.csv", DataFrame,header=false)
t_plt_original = CSV.read("test/Rain_2M/t_plt_original.csv", DataFrame,header=false)
z_plt_original = CSV.read("test/Rain_2M/z_plt_original.csv", DataFrame,header=false)
z_centers_end_original = CSV.read("test/Rain_2M/z_centers_end_original.csv", DataFrame,header=false)
z_centers_middle_original = CSV.read("test/Rain_2M/z_centers_middle_original.csv", DataFrame,header=false)
