...
function get_observations_config()
    ...
    # Define data
    root_dir = "/Users/sajjadazimi/Postdoc/Results/04-PySDM_0D_BoxModel/data/"
...
function get_model_config()
    ...
    config["filter"] = make_filter_props(
        ones(Int, 4),
        config["t_calib"];
        apply = true,
        nz_per_filtered_cell = ones(Int, 4),
